<div class="col-span-{{ $size ?? '6' }} {{ $class }} space-y-1"
     x-data="Components.customSelect({ open: false, value: 'ru', selected: 'ru' })"
     x-init="init()"
>
    ...
    <div class="relative">
        <span class="inline-block w-full rounded-md shadow-sm">
            ...
            >
                <span x-text="[@json($options)][value]" class="block truncate"></span>
